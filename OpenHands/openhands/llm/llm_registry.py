...
class LLMRegistry:
    ...
    def close(self) -> None:
        ...
        This clears all LLM instances to help with garbage collection
        and releases any associated resources.
        """
        # Clear subscriber to prevent further notifications
        self.subscriber = None

        # Clear all LLM references to allow garbage collection
        # LLM instances use litellm which may hold httpx connections
